...
stdenv.mkDerivation rec {
  ...
  patches = [ ]
    ++ lib.optional (stdenv.isLinux) [ ./0001-Compile-transupp.c-as-part-of-the-library.patch ]
  ...
  cmakeFlags = [
    ...
    "-DCMAKE_C_COMPILER=${if stdenv.hostPlatform.parsed.cpu.name == "x86_64" then "x86_64-w64-mingw32-gcc" else "i686-w64-mingw32-gcc"}"
    "-DCMAKE_RC_COMPILER=${if stdenv.hostPlatform.parsed.cpu.name == "x86_64" then "x86_64-w64-mingw32-windres" else "i686-w64-mingw32-windres"}"
  ];
