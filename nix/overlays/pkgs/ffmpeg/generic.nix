...
, withPulse ? withSmallDeps && !stdenv.isDarwin && !stdenv.hostPlatform.isMinGW # Pulseaudio input support
...
, withV4l2 ? withHeadlessDeps && !stdenv.isDarwin && !stdenv.hostPlatform.isMinGW # Video 4 Linux support
